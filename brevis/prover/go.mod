...
replace github.com/consensys/gnark => github.com/brevis-network/gnark v0.1.0

replace github.com/ethereum/go-ethereum => github.com/celer-network/go-ethereum v0.0.0-20250328211401-63ec28a3ab84
